...
@app.get("/api/tools/x-tool")
async def x_tool(current_user: User = Depends(require_tool_access("x_tool"))):
    return {"message": "X Tool accessed successfully", "user": current_user.username}

@app.get("/api/tools/y-tool")
async def y_tool(current_user: User = Depends(require_tool_access("y_tool"))):
    return {"message": "Y Tool accessed successfully", "user": current_user.username}
